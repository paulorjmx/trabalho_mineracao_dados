...
-- Utilizamos a window function de lag pra pegar as mudanças de status, 
-- ou seja, se um paciente fez 4 exames sendo o primeiro negativo e os outros 
-- positivos pegamos a diferença de datas entre o primeiro e o segundo exame,
-- e não a distância entre o primeiro positivo e o ultimo negativo.
SELECT
    id_paciente,
    resultado,
	resultado_lag,
